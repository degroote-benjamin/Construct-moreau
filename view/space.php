...
<div class="container">
    ...
    foreach ($dataproject as $valueproject) {
        ?>
            <tr>
                <td>
                    <?php echo $valueproject['id_project']; ?>
                </td>
                <td>
                    <a href="../control/step_area.php?id_project=<?php echo $valueproject['id_project']?>">
                        <?php echo $valueproject['project_name'] ?>
                    </a>
                </td>
                <td>
                    <?php echo $valueproject['description_project'] ?>
                </td>
                <td>
                    <?php echo $valueproject['category_name'] ?>
                </td>
                <td>
                    <?php echo $valueproject['end_date'] ?>
                </td>
                <td>
